        ...
        <div class="dropdown-menu py-0" aria-labelledby="candidateFilterBtn">
            ...
            <div class="p-5">
                  <div class="mb-5">
                           ...
                           {{ Form::select('status',collect($filterHeads[0])->sortBy('key')->toArray(),null,['class' => 'form-select io-select2 abc', 'data-control' => 'select2', 'id' => 'candidateStatus']) }}
                  </div>
                <div class="mb-5">
                           <label for="filterBtn" class="form-label">{{__('messages.candidate.immediate_available')}}:</label>
                           {{ Form::select('immediate_available', collect($filterHeads[1])->sortBy('key')->toArray(),null,['class' => 'form-select io-select2', 'data-control'=>"select2", 'id' => 'immediatAvailable']) }}
                       </div>
