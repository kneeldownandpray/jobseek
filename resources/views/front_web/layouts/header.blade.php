                ...
                <nav class="navbar navbar-expand-lg navbar-light justify-content-end py-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <ul class="navbar-nav align-items-center py-2 py-lg-0">
                            <li class="nav-item">
                                <a class="header-navbar-color text-dark nav-link {{ Request::is('/') ? 'header-navbar-color-active' : '' }}" aria-current="page"
                                   href="{{ route('front.home') }}">{{ __('web.home') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="header-navbar-color text-dark nav-link {{ Request::is('search-jobs') || Request::is('job-details*') ? 'header-navbar-color-active' : '' }}"
                                   href="{{ route('front.search.jobs') }}">{{ __('web.jobs') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="header-navbar-color text-dark nav-link {{ Request::is('company-lists') || Request::is('company-details*') ? 'header-navbar-color-active' : '' }}"
                                   href="{{ route('front.company.lists') }}">{{ __('web.companies') }}</a>
                            </li>
                            @auth
                                @role('Employer|Admin')
                                <li class="nav-item">
                                    <a class="header-navbar-color text-dark nav-link {{ Request::is('candidate-lists') || Request::is('candidate-details*') ? 'header-navbar-color-active' : '' }}"
                                       href="{{ route('front.candidate.lists') }}">{{ __('web.job_seekers') }}</a>
                                </li>
                                @endrole
                            @endauth
                            <li class="nav-item">
                                <a class="header-navbar-color text-dark nav-link {{ Request::is('about-us') ? 'header-navbar-color-active' : '' }}"
                                   href="{{ route('front.about.us') }}">{{ __('web.about_us') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="header-navbar-color text-dark nav-link {{ Request::is('contact-us') ? 'header-navbar-color-active' : '' }}"
                                   href="{{ route('front.contact') }}">{{ __('web.contact_us') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="header-navbar-color text-dark nav-link {{ Request::is('posts*') ? 'header-navbar-color-active' : '' }}"
