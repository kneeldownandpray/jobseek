                                    ...
                                    <div class="hero-desc d-flex flex-wrap">
                                        ...
                                        <div class="desc d-flex me-4 pe-2">
                                            @if ($isJobReportedAsAbuse)
                                                <button type="button" class="btn btn-outline-danger reportJobAbuse" disabled
                                        ...
                                        <div class="desc d-flex me-4 pe-2">
                                            ...
                                            @else
                                                <button
                                                    class="btn btn-outline-primary ml-2">{{ __('web.job_details.already_applied') }}</button>
                                            @endif
                                        </div>
                                    </div>
                                @endrole
         ...
         <div class="container">
             <div class="row">
                 ...
                 @if(Session::has('warning'))
                     <div class="col-md-12 col-sm-12">
                         <div class="alert alert-warning" role="alert" data-turbo="false">
                             {{ Session::get('warning') }}
